...
@section('content')
    <div id="page-title"><h2>View Admins</h2>
        <p>System Admins</p>
    ...
    <div class="panel">
        <div class="panel-body">
            ...
            <a type="submit" href="{{route('admin.create')}}"
                    class="btn btn-success" title="Add"><i class="fas fa-user-plus"></i> Add Admin</a>
            </div>
            <br>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    ...
                                    <div class="col col-3">
                                        <a class="btn btn-default" href="{{route('admin.edit',$admin->id)}}">Edit</a>
                                    </div>
                                    <div class="col col-3">
