...
@section('content')
    <div id="page-title"><h2>Add Farmer</h2>
        <p>Create Farmer</p>
    ...
    <div class="panel">
        <div class="panel-body"><h3 class="title-hero">Farmer Form</h3>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <label class="col-sm-3 control-label">Farm</label>
                                    <div class="col-sm-6">
                                        <select name="farmId"
                                                required class="form-control">
                                            <option value="">Select One</option>
                                            @foreach($farms as $farm)
                                                <option value="{{$farm->id}}">{{$farm->farmNumber}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
